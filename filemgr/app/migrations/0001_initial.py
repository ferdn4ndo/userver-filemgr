# Generated by Django 3.2.12 on 2022-03-19 01:14

import app.services.strings
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('signature_key', models.CharField(default=app.services.strings.generate_random_encoded_string, max_length=64)),
                ...
                ('storage', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, to='app.storage')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dimensions', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.storagefileimagedimensions')),
                ('storage_file', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, to='app.storagefile')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('download_url', models.CharField(default=app.services.strings.generate_random_encoded_string, max_length=255, verbose_name='Final url (should be signed) to the file to be downloaded')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Record creation timestamp')),
                ...
                ('storage_file', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.storagefile', verbose_name='The file to be downloaded')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='type',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.storagefilemimetype'),
        ),
        migrations.AddField(
            model_name='storagefile',
            name='updated_by',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Record creation timestamp')),
                ('download', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, to='app.storagefiledownload')),
