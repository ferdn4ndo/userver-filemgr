...
from core.models import StorageFile, User, StorageUser
from core.services.translation.translation_service import Messages


class StorageFileViewService:
    def check_file_permissions(self, storage_file: StorageFile, user: User, write: bool = False):
    ...
    @staticmethod
    def delete_storage_file(storage_file: StorageFile, user: User, soft_delete: bool = True) -> Response:
        if soft_delete:
