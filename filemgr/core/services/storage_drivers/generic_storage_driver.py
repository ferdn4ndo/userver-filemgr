...
class GenericStorageDriver(ABC):
    ...
    def perform_basic_upload_operations(
        ...
        storage_file.real_path = self.generate_real_path(storage_file)
    ...
    @staticmethod
    def generate_virtual_path(file: StorageFile, virtual_path: str = None, is_url: bool = False):
        """
