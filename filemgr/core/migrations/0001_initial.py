# Generated by Django 4.1.4 on 2022-12-16 05:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('IMAGE', 'The media item is an image.'), ('VIDEO', 'The media item is a video.')], max_length=64, verbose_name='The type of the media item')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('megapixels', models.DecimalField(decimal_places=4, max_digits=7, null=True, verbose_name='Total millions of pixels (h x w) of the image')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_creator', to=settings.AUTH_USER_MODEL, verbose_name='Record creation user')),
                ('media_image', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, to='core.mediaimage')),
        ...
        migrations.AddField(
            model_name='media',
            name='storage_file',
            field=models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='media_file', to='core.storagefile'),
        ),
        migrations.AddField(
            model_name='media',
            name='updated_by',
